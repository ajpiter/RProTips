Choose the best visualization, based on the type of data you are representing. Common examples are below, for additional examples reference the ggplot cheat sheet. 
